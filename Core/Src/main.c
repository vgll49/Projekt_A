...
static void MX_ADC1_Init(void)
{
  ...
  */
  ...
  hadc1.Init.ExternalTrigConv = ADC_EXTERNALTRIGCONV_T3_TRGO; // Timer 3 trigger output
...
static void MX_TIM3_Init(void)
{
  ...
  sMasterConfig.MasterOutputTrigger = TIM_TRGO_UPDATE; // Timer-Update startet ADC Messung
